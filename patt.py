...
###REM    def __init__(self, position, text, tag, ud=dep_v1):
    def __init__(self, position, text, tag, ud=dep_v2):
...
###REM    def __init__(self, root, ud=dep_v1, rules=[]):
    def __init__(self, root, ud=dep_v2, rules=[]):
        self.root = root
        self.rules = rules
...
###REM    def __init__(self, root, ud=dep_v1, rules=[], type_=NORMAL):
    def __init__(self, root, ud=dep_v2, rules=[], type_=NORMAL):
        self.root = root
        self.rules = rules
        self.position = root.position
        self.ud = ud
